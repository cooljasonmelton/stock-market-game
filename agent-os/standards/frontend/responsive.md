...
- **Standard Breakpoints**: Consistently use the project’s canonical breakpoints (e.g., Tailwind `sm`/`md`/`lg`) across CSS, design tokens, and tests
...
- **Visual Regression**: Capture visual regression snapshots (Storybook/Playwright) at each breakpoint whenever shared components change
