...
- **Automated Checks**: Run axe (or Storybook accessibility add-ons) locally and in CI to catch regressions before code review
- **Interactive Verification**: Capture keyboard/screen-reader acceptance criteria in tickets and verify modals, menus, and dialogs against them
