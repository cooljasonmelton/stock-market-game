...
- **Shared Tokens**: Reference the centralized Tailwind (or equivalent) theme tokens instead of redefining colors/spacing in-line
- **No Magic Numbers**: Avoid unexplained pixel values—tie dimensions to spacing scale variables or document the rationale
